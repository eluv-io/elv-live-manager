...
import {FileInput, Form, Input, Select, TextArea} from "Components/common/Inputs";
  ...
  return (
    <Form>
      <div className="form__section">
        ...
        <Select label="Type" objectId={objectId} path={basePath} name="type" options={["URL", "Rich Text", "HTML"]}>
...
export const Footer = observer(() => {
  ...
  return (
    <Form>
      ...
      />
      <div className="form__section">
        <Input type="checkbox" label="Show Default Privacy Policy" objectId={objectId} path="info" name="show_privacy_policy" default_value={true} />
        <Input type="checkbox" label="Show Default Terms of Service" objectId={objectId} path="info" name="show_terms" default_value={true} />
        <Input type="checkbox" label="Show FAQ" objectId={objectId} path="info" name="show_faq" default_value={true} />
        <Input type="checkbox" label="Custom FAQ" objectId={objectId} path="info" name="show_custom_faq" default_value={false} dependsOn="info/show_faq" />
      </div>
    </Form>
  );
});
